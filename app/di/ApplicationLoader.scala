...
class ApplicationComponents(context: Context)
  ...
  lazy val repositoryController = new controllers.RepositoryController(controllerComponents, commitRepository)
...
trait PersistenceComponents {
  ...
  lazy val commitRepository = new models.CommitRepository(defaultDbProvider)
